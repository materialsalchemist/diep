#!/bin/bash
#SBATCH --job-name=diep_pes
#SBATCH --output=diep_pes.out
#SBATCH --error=diep_pes.err
#SBATCH --nodes=1
...
python train_pes_mp.py --model dft --dataset mp_pes --no-uses --fw 1 --lr 0.0001 --lg --exclude_force_outliers  --full_dataset
